...
export class Deals extends APIResource {
  ...
  create(
    ...
    return this._client.post(path`/v2/prism/${teamId}/deal`, {
      body,
      ...options,
  ...
  list(
    ...
    return this._client.get(path`/v2/prism/${teamId}/deal`, { query, ...options });
  }
  ...
  bulkCreate(params: DealBulkCreateParams, options?: RequestOptions): APIPromise<DealBulkCreateResponse> {
    const { teamId = this._client.teamID, 'Idempotency-Key': idempotencyKey, ...body } = params;
    return this._client.post(path`/v2/prism/${teamId}/deal/import`, {
      body,
      ...options,
      headers: buildHeaders([
        { ...(idempotencyKey != null ? { 'Idempotency-Key': idempotencyKey } : undefined) },
  ...
  bulkDelete(params: DealBulkDeleteParams, options?: RequestOptions): APIPromise<DealBulkDeleteResponse> {
    const { teamId = this._client.teamID, 'Idempotency-Key': idempotencyKey, ...body } = params;
    return this._client.post(path`/v2/prism/${teamId}/deal/batch/delete`, {
      body,
      ...options,
      headers: buildHeaders([
        { ...(idempotencyKey != null ? { 'Idempotency-Key': idempotencyKey } : undefined) },
  ...
  bulkUpdate(params: DealBulkUpdateParams, options?: RequestOptions): APIPromise<DealBulkUpdateResponse> {
    const { teamId = this._client.teamID, 'Idempotency-Key': idempotencyKey, ...body } = params;
    return this._client.post(path`/v2/prism/${teamId}/deal/batch/update`, {
      body,
      ...options,
      headers: buildHeaders([
        { ...(idempotencyKey != null ? { 'Idempotency-Key': idempotencyKey } : undefined) },
  ...
  count(
    ...
    options?: RequestOptions,
  ): APIPromise<DealCountResponse> {
    const { teamId = this._client.teamID, ...query } = params ?? {};
    return this._client.get(path`/v2/prism/${teamId}/deal/count`, { query, ...options });
  }
  ...
  duplicate(
    ...
    return this._client.post(path`/v2/prism/${teamId}/deal/${dealID}/duplicate`, {
      ...options,
      headers: buildHeaders([
        { ...(idempotencyKey != null ? { 'Idempotency-Key': idempotencyKey } : undefined) },
        options?.headers,
  ...
  find(value: string, params: DealFindParams, options?: RequestOptions): APIPromise<DealFindResponse> {
    ...
    return this._client.get(path`/v2/prism/${teamId}/deal/by/${slug}/${value}`, { query, ...options });
  }
  ...
  get(
    ...
    const { teamId = this._client.teamID, ...query } = params ?? {};
    return this._client.get(path`/v2/prism/${teamId}/deal/${dealID}`, { query, ...options });
  }
  ...
  restore(
    ...
    const { teamId = this._client.teamID, 'Idempotency-Key': idempotencyKey } = params ?? {};
    return this._client.post(path`/v2/prism/${teamId}/deal/${dealID}/restore`, {
      ...options,
      headers: buildHeaders([
        { ...(idempotencyKey != null ? { 'Idempotency-Key': idempotencyKey } : undefined) },
        options?.headers,
  ...
  upsert(value: string, params: DealUpsertParams, options?: RequestOptions): APIPromise<DealUpsertResponse> {
    ...
    return this._client.put(path`/v2/prism/${teamId}/deal/by/${slug}/${value}`, {
      body,
      ...options,
      headers: buildHeaders([
        { ...(idempotencyKey != null ? { 'Idempotency-Key': idempotencyKey } : undefined) },
...
export interface DealListResponse {
  data: Array<DealListResponse.Data>;
...
export namespace DealListResponse {
  /**
...
export interface DealBulkCreateResponse {
   ...
   */
  error?: DealBulkCreateResponse.Error;
 ...
 */
export interface DealBulkDeleteResponse {
  results: Array<DealBulkDeleteResponse.Result>;

  summary: DealBulkDeleteResponse.Summary;
}

export namespace DealBulkDeleteResponse {
  export interface Result {
    /**
...
export interface DealBulkUpdateResponse {
  results: Array<DealBulkUpdateResponse.Result>;

  summary: DealBulkUpdateResponse.Summary;
}

export namespace DealBulkUpdateResponse {
  export interface Result {
    /**
     * Item ID, or null if the input was unparseable.
     */
...
export interface DealCountResponse {
  /**
 ...
 * Object returned by reads (get/create/patch/restore). id is always present.
 */
export interface DealFindResponse {
  id: string;
 ...
 * Object returned by reads (get/create/patch/restore). id is always present.
 */
export interface DealUpsertResponse {
  id: string;
...
export interface DealBulkDeleteParams {
  /**
   * Path param
   */
  teamId?: string;
...
export interface DealBulkUpdateParams {
  /**
   * Path param
   */
  teamId?: string;
...
export namespace DealBulkUpdateParams {
  /**
...
export interface DealCountParams {
  /**
   * Path param
   */
  teamId?: string;
...
export interface DealFindParams {
  /**
   * Path param
   */
  teamId?: string;
