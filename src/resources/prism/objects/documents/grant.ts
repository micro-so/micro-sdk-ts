...
export class Grant extends APIResource {
  ...
  update(
    ...
    return this._client.put(path`/v2/prism/grant/${teamId}/document/${documentID}`, { body, ...options });
  }
  ...
  get(
    ...
    return this._client.get(path`/v2/prism/grant/${teamId}/document/${documentID}`, options);
  }
}
