...
export class Grant extends APIResource {
  ...
  update(
    ...
    return this._client.put(path`/v2/prism/grant/${teamId}/identity/${identityID}`, { body, ...options });
  }
  ...
  get(
    ...
    return this._client.get(path`/v2/prism/grant/${teamId}/identity/${identityID}`, options);
  }
}
