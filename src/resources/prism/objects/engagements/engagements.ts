...
export class Engagements extends APIResource {
   ...
   * ```ts
   * const engagement =
   *   await client.prism.objects.engagements.create({
   *     default: {
   ...
   */
  create(
    params: EngagementCreateParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<EngagementCreateResponse> {
    const { teamId = this._client.teamID, 'Idempotency-Key': idempotencyKey, ...body } = params ?? {};
    return this._client.post(path`/v2/prism/${teamId}/engagement`, {
      body,
      ...options,
   ...
   * ```ts
   * const engagement =
   *   await client.prism.objects.engagements.update(
  ...
  update(
    ...
    options?: RequestOptions,
  ): APIPromise<EngagementUpdateResponse> {
    const {
    ...
    return this._client.patch(path`/v2/prism/${teamId}/engagement/${engagementID}`, {
      body,
      ...options,
      headers: buildHeaders([
        {
   ...
   * ```ts
   * const engagements =
   *   await client.prism.objects.engagements.list();
   * ```
   */
  list(
    params: EngagementListParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<EngagementListResponse> {
    const { teamId = this._client.teamID, ...query } = params ?? {};
    return this._client.get(path`/v2/prism/${teamId}/engagement`, { query, ...options });
  }
   ...
   * @example
   * ```ts
   * await client.prism.objects.engagements.delete(
   *   '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
   * );
   * ```
   */
  delete(
    engagementID: string,
    params: EngagementDeleteParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<void> {
    const { teamId = this._client.teamID, 'If-Match': ifMatch } = params ?? {};
    return this._client.delete(path`/v2/prism/${teamId}/engagement/${engagementID}`, {
      ...options,
      headers: buildHeaders([
   ...
   * ```ts
   * const response =
   *   await client.prism.objects.engagements.bulkCreate({
   *     objects: [{}],
   *   });
   * ```
   */
  bulkCreate(
    params: EngagementBulkCreateParams,
    options?: RequestOptions,
  ): APIPromise<EngagementBulkCreateResponse> {
    const { teamId = this._client.teamID, 'Idempotency-Key': idempotencyKey, ...body } = params;
    return this._client.post(path`/v2/prism/${teamId}/engagement/import`, {
      body,
      ...options,
      headers: buildHeaders([
        { ...(idempotencyKey != null ? { 'Idempotency-Key': idempotencyKey } : undefined) },
   ...
   * ```ts
   * const response =
   *   await client.prism.objects.engagements.bulkDelete({
   *     ids: ['182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e'],
   *   });
   * ```
   */
  bulkDelete(
    params: EngagementBulkDeleteParams,
    options?: RequestOptions,
  ): APIPromise<EngagementBulkDeleteResponse> {
    const { teamId = this._client.teamID, 'Idempotency-Key': idempotencyKey, ...body } = params;
    return this._client.post(path`/v2/prism/${teamId}/engagement/batch/delete`, {
      body,
      ...options,
      headers: buildHeaders([
        { ...(idempotencyKey != null ? { 'Idempotency-Key': idempotencyKey } : undefined) },
   ...
   * ```ts
   * const response =
   *   await client.prism.objects.engagements.bulkUpdate({
   *     items: [{ id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e' }],
   *   });
   * ```
   */
  bulkUpdate(
    params: EngagementBulkUpdateParams,
    options?: RequestOptions,
  ): APIPromise<EngagementBulkUpdateResponse> {
    const { teamId = this._client.teamID, 'Idempotency-Key': idempotencyKey, ...body } = params;
    return this._client.post(path`/v2/prism/${teamId}/engagement/batch/update`, {
      body,
      ...options,
      headers: buildHeaders([
        { ...(idempotencyKey != null ? { 'Idempotency-Key': idempotencyKey } : undefined) },
   ...
   * ```ts
   * const response =
   *   await client.prism.objects.engagements.count();
   * ```
   */
  count(
    params: EngagementCountParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<EngagementCountResponse> {
    const { teamId = this._client.teamID, ...query } = params ?? {};
    return this._client.get(path`/v2/prism/${teamId}/engagement/count`, { query, ...options });
  }
   ...
   * ```ts
   * const response =
   *   await client.prism.objects.engagements.duplicate(
   *     '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
   *   );
   * ```
   */
  duplicate(
    engagementID: string,
    params: EngagementDuplicateParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<EngagementDuplicateResponse> {
    const { teamId = this._client.teamID, 'Idempotency-Key': idempotencyKey } = params ?? {};
    return this._client.post(path`/v2/prism/${teamId}/engagement/${engagementID}/duplicate`, {
      ...options,
      headers: buildHeaders([
        { ...(idempotencyKey != null ? { 'Idempotency-Key': idempotencyKey } : undefined) },
        options?.headers,
   ...
   * ```ts
   * const response =
   *   await client.prism.objects.engagements.find('value', {
   *     slug: 'slug',
   *   });
   * ```
   */
  find(
    value: string,
    params: EngagementFindParams,
    options?: RequestOptions,
  ): APIPromise<EngagementFindResponse> {
    const { teamId = this._client.teamID, slug, ...query } = params;
    return this._client.get(path`/v2/prism/${teamId}/engagement/by/${slug}/${value}`, { query, ...options });
  }
   ...
   * ```ts
   * const engagement =
   *   await client.prism.objects.engagements.get(
   *     '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
   *   );
   * ```
   */
  get(
    engagementID: string,
    params: EngagementGetParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<EngagementGetResponse> {
    const { teamId = this._client.teamID, ...query } = params ?? {};
    return this._client.get(path`/v2/prism/${teamId}/engagement/${engagementID}`, { query, ...options });
  }
   ...
   * ```ts
   * const response =
   *   await client.prism.objects.engagements.query({
   *     query: {
   *       select: [
   *         'full_name',
   *         'email',
   ...
   * ```
   */
  query(params: EngagementQueryParams, options?: RequestOptions): APIPromise<EngagementQueryResponse> {
    const { teamId = this._client.teamID, 'Idempotency-Key': idempotencyKey, ...body } = params;
    return this._client.post(path`/v2/prism/${teamId}/engagement/query`, {
      body,
      ...options,
      headers: buildHeaders([
        { ...(idempotencyKey != null ? { 'Idempotency-Key': idempotencyKey } : undefined) },
   ...
   * ```ts
   * const response =
   *   await client.prism.objects.engagements.restore(
   *     '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
   *   );
   * ```
   */
  restore(
    engagementID: string,
    params: EngagementRestoreParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<EngagementRestoreResponse> {
    const { teamId = this._client.teamID, 'Idempotency-Key': idempotencyKey } = params ?? {};
    return this._client.post(path`/v2/prism/${teamId}/engagement/${engagementID}/restore`, {
      ...options,
      headers: buildHeaders([
        { ...(idempotencyKey != null ? { 'Idempotency-Key': idempotencyKey } : undefined) },
        options?.headers,
   ...
   * ```ts
   * const response =
   *   await client.prism.objects.engagements.upsert('value', {
   *     slug: 'slug',
   *   });
   * ```
   */
  upsert(
    value: string,
    params: EngagementUpsertParams,
    options?: RequestOptions,
  ): APIPromise<EngagementUpsertResponse> {
    const {
      teamId = this._client.teamID,
      slug,
      list_id,
    ...
    return this._client.put(path`/v2/prism/${teamId}/engagement/by/${slug}/${value}`, {
      query: { list_id },
      body,
      ...options,
      headers: buildHeaders([
 ...
 */
export interface EngagementCreateResponse {
  id: string;
...
export interface EngagementListResponse {
  data: Array<EngagementListResponse.Data>;
...
export namespace EngagementListResponse {
  /**
 ...
 */
export interface EngagementBulkCreateResponse {
  /**
   ...
   */
  error?: EngagementBulkCreateResponse.Error;
   ...
   */
  results?: Array<EngagementBulkCreateResponse.Result>;
...
export namespace EngagementBulkCreateResponse {
  /**
   * Set when status=failed; describes the job-level failure (not per-row).
   */
 ...
 */
export interface EngagementBulkDeleteResponse {
  results: Array<EngagementBulkDeleteResponse.Result>;

  summary: EngagementBulkDeleteResponse.Summary;
}

export namespace EngagementBulkDeleteResponse {
  export interface Result {
    /**
 ...
 * operation as a whole returns 200 even if some items failed.
 */
export interface EngagementBulkUpdateResponse {
  results: Array<EngagementBulkUpdateResponse.Result>;

  summary: EngagementBulkUpdateResponse.Summary;
}

export namespace EngagementBulkUpdateResponse {
  export interface Result {
    /**
     * Item ID, or null if the input was unparseable.
     */
...
export interface EngagementCountResponse {
  /**
 ...
 * Object returned by reads (get/create/patch/restore). id is always present.
 */
export interface EngagementDuplicateResponse {
  id: string;
 ...
 * Object returned by reads (get/create/patch/restore). id is always present.
 */
export interface EngagementFindResponse {
  id: string;
 ...
 * Object returned by reads (get/create/patch/restore). id is always present.
 */
export interface EngagementGetResponse {
  id: string;
...
export interface EngagementQueryResponse {
  data: Array<EngagementQueryResponse.Data>;
...
export namespace EngagementQueryResponse {
  /**
   * Row returned by the query endpoint. `id` is always present at the top level.
   * Selected property values are returned under `properties`, keyed by property
   * slug. Reference-typed values are returned as nested `{ id, properties }`
 ...
 * Object returned by reads (get/create/patch/restore). id is always present.
 */
export interface EngagementRestoreResponse {
  id: string;
 ...
 * Object returned by reads (get/create/patch/restore). id is always present.
 */
export interface EngagementUpsertResponse {
  id: string;
...
export interface EngagementUpdateParams {
  /**
   * Path param
   */
  teamId?: string;
...
export interface EngagementDeleteParams {
  /**
   * Path param
   */
  teamId?: string;
...
export interface EngagementBulkCreateParams {
  /**
   * Path param
   */
  teamId?: string;
   ...
   * Body param
   */
  options?: EngagementBulkCreateParams.Options;
...
export namespace EngagementBulkCreateParams {
...
export interface EngagementBulkDeleteParams {
  /**
   * Path param
   */
  teamId?: string;
...
export interface EngagementBulkUpdateParams {
  /**
   * Path param
   */
  teamId?: string;
   ...
   * Body param
   */
  items: Array<EngagementBulkUpdateParams.Item>;
...
export namespace EngagementBulkUpdateParams {
  /**
...
export interface EngagementCountParams {
  /**
   * Path param
   */
  teamId?: string;
...
export interface EngagementDuplicateParams {
  /**
   * Path param
   */
  teamId?: string;
...
export interface EngagementFindParams {
  /**
   * Path param
   */
  teamId?: string;
...
export interface EngagementGetParams {
  /**
   * Path param
   */
  teamId?: string;
...
export interface EngagementQueryParams {
   ...
   * Body param
   */
  query: EngagementQueryParams.Query;
...
export namespace EngagementQueryParams {
...
export interface EngagementRestoreParams {
  /**
   * Path param
   */
  teamId?: string;
...
export interface EngagementUpsertParams {
  /**
   * Path param
   */
  teamId?: string;
