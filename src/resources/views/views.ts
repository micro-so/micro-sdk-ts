...
export class Views extends APIResource {
  ...
  create(
    ...
    return this._client.post(path`/v2/prism/${teamId}/${objectType}/views`, {
      body,
      ...options,
  ...
  update(viewID: string, params: ViewUpdateParams, options?: RequestOptions): APIPromise<ViewUpdateResponse> {
    ...
    return this._client.patch(path`/v2/prism/${teamId}/${objectType}/views/${viewID}`, {
      body,
      ...options,
      headers: buildHeaders([
        { ...(idempotencyKey != null ? { 'Idempotency-Key': idempotencyKey } : undefined) },
  ...
  list(
    ...
    return this._client.get(path`/v2/prism/${teamId}/${objectType}/views`, { query, ...options });
  }
  ...
  delete(viewID: string, params: ViewDeleteParams, options?: RequestOptions): APIPromise<void> {
    ...
    return this._client.delete(path`/v2/prism/${teamId}/${objectType}/views/${viewID}`, {
      ...options,
  ...
  get(viewID: string, params: ViewGetParams, options?: RequestOptions): APIPromise<ViewGetResponse> {
    ...
    return this._client.get(path`/v2/prism/${teamId}/${objectType}/views/${viewID}`, { query, ...options });
  }
}
