...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response: '{ id?: string; crm?: object; default?: object; extended?: object; }',
    markdown:
      "## create_object\n\n`client.prism.createObject(teamId: string, objectType: 'deal' | 'identity' | 'ai_chat_thread' | 'ai_chat_message' | 'document' | 'action' | 'event', id?: string, crm?: object, default?: object, extended?: object): { id?: string; crm?: object; default?: object; extended?: object; }`\n\n**post** `/v2/prism/{teamId}/{objectType}`\n\nCreate object\n\n### Parameters\n\n- `teamId: string`\n\n- `objectType: 'deal' | 'identity' | 'ai_chat_thread' | 'ai_chat_message' | 'document' | 'action' | 'event'`\n\n- `id?: string`\n\n- `crm?: object`\n\n- `default?: object`\n  Properties keyed by property slug. Values can be strings, numbers, booleans, arrays, or null.\n\n- `extended?: object`\n\n### Returns\n\n- `{ id?: string; crm?: object; default?: object; extended?: object; }`\n\n  - `id?: string`\n  - `crm?: object`\n  - `default?: object`\n  - `extended?: object`\n\n### Example\n\n```typescript\nimport Micro from 'micro';\n\nconst client = new Micro();\n\nconst prismObjectProperties = await client.prism.createObject('deal');\n\nconsole.log(prismObjectProperties);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response: '{ id?: string; crm?: object; default?: object; extended?: object; }',
    markdown:
      "## patch_object\n\n`client.prism.patchObject(teamId: string, objectType: 'deal' | 'identity' | 'ai_chat_thread' | 'ai_chat_message' | 'document' | 'action' | 'event', objectId: string, id?: string, crm?: object, default?: object, extended?: object): { id?: string; crm?: object; default?: object; extended?: object; }`\n\n**patch** `/v2/prism/{teamId}/{objectType}/{objectId}`\n\nPatch object\n\n### Parameters\n\n- `teamId: string`\n\n- `objectType: 'deal' | 'identity' | 'ai_chat_thread' | 'ai_chat_message' | 'document' | 'action' | 'event'`\n\n- `objectId: string`\n\n- `id?: string`\n\n- `crm?: object`\n\n- `default?: object`\n  Properties keyed by property slug. Values can be strings, numbers, booleans, arrays, or null.\n\n- `extended?: object`\n\n### Returns\n\n- `{ id?: string; crm?: object; default?: object; extended?: object; }`\n\n  - `id?: string`\n  - `crm?: object`\n  - `default?: object`\n  - `extended?: object`\n\n### Example\n\n```typescript\nimport Micro from 'micro';\n\nconst client = new Micro();\n\nconst prismObjectProperties = await client.prism.patchObject('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { objectType: 'deal' });\n\nconsole.log(prismObjectProperties);\n```",
    perLanguage: {
      typescript: {
        method: 'client.prism.patchObject',
        example:
          "import Micro from 'micro';\n\nconst client = new Micro({\n  teamID: 'My Team ID',\n  apiKey: process.env['MICRO_API_KEY'], // This is the default and can be omitted\n});\n\nconst prismObjectProperties = await client.prism.patchObject(\n  '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',\n  { objectType: 'deal' },\n);\n\nconsole.log(prismObjectProperties.id);",
      },
      python: {
        method: 'prism.patch_object',
        example:
          'import os\nfrom micro import Micro\n\nclient = Micro(\n    api_key=os.environ.get("MICRO_API_KEY"),  # This is the default and can be omitted\n)\nprism_object_properties = client.prism.patch_object(\n    object_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n    object_type="deal",\n)\nprint(prism_object_properties.id)',
      },
      go: {
        method: 'client.Prism.PatchObject',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/micro-go"\n\t"github.com/stainless-sdks/micro-go/option"\n)\n\nfunc main() {\n\tclient := micro.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t\toption.WithTeamID("My Team ID"),\n\t)\n\tprismObjectProperties, err := client.Prism.PatchObject(\n\t\tcontext.TODO(),\n\t\tmicro.ObjectTypeDeal,\n\t\t"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n\t\tmicro.PrismPatchObjectParams{\n\t\t\tPrismObjectProperties: micro.PrismObjectPropertiesParam{},\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", prismObjectProperties.ID)\n}\n',
      },
      cli: {
        method: 'prism patch_object',
        example:
  ...
  },
  {
    ...
    markdown:
      "## retrieve_grant\n\n`client.prism.grant.retrieveGrant(teamId: string, objectType: 'deal' | 'identity' | 'ai_chat_thread' | 'ai_chat_message' | 'document' | 'action' | 'event', objectId: string): { team_group_id?: object[]; team_id?: object; user_id?: object[]; }`\n\n**get** `/v2/prism/grant/{teamId}/{objectType}/{objectId}`\n\nGet grant\n\n### Parameters\n\n- `teamId: string`\n\n- `objectType: 'deal' | 'identity' | 'ai_chat_thread' | 'ai_chat_message' | 'document' | 'action' | 'event'`\n\n- `objectId: string`\n\n### Returns\n\n- `{ team_group_id?: object[]; team_id?: object; user_id?: object[]; }`\n\n  - `team_group_id?: object[]`\n  - `team_id?: object`\n  - `user_id?: object[]`\n\n### Example\n\n```typescript\nimport Micro from 'micro';\n\nconst client = new Micro();\n\nconst response = await client.prism.grant.retrieveGrant('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { objectType: 'deal' });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
        method: 'client.prism.grant.retrieveGrant',
        example:
          "import Micro from 'micro';\n\nconst client = new Micro({\n  teamID: 'My Team ID',\n  apiKey: process.env['MICRO_API_KEY'], // This is the default and can be omitted\n});\n\nconst response = await client.prism.grant.retrieveGrant('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {\n  objectType: 'deal',\n});\n\nconsole.log(response.team_group_id);",
      },
      python: {
        method: 'prism.grant.retrieve_grant',
        example:
          'import os\nfrom micro import Micro\n\nclient = Micro(\n    api_key=os.environ.get("MICRO_API_KEY"),  # This is the default and can be omitted\n)\nresponse = client.prism.grant.retrieve_grant(\n    object_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n    object_type="deal",\n)\nprint(response.team_group_id)',
      },
      go: {
        method: 'client.Prism.Grant.GetGrant',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/micro-go"\n\t"github.com/stainless-sdks/micro-go/option"\n)\n\nfunc main() {\n\tclient := micro.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t\toption.WithTeamID("My Team ID"),\n\t)\n\tresponse, err := client.Prism.Grant.GetGrant(\n\t\tcontext.TODO(),\n\t\tmicro.ObjectTypeDeal,\n\t\t"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n\t\tmicro.PrismGrantGetGrantParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response.TeamGroupID)\n}\n',
      },
      cli: {
  ...
  },
  {
    ...
    response: '{ team_group_id?: object[]; team_id?: object; user_id?: object[]; }',
    markdown:
      "## update_grant\n\n`client.prism.grant.updateGrant(teamId: string, objectType: 'deal' | 'identity' | 'ai_chat_thread' | 'ai_chat_message' | 'document' | 'action' | 'event', objectId: string, team_group_id?: object[], team_id?: object, user_id?: object[]): { team_group_id?: object[]; team_id?: object; user_id?: object[]; }`\n\n**put** `/v2/prism/grant/{teamId}/{objectType}/{objectId}`\n\nUpdate grant\n\n### Parameters\n\n- `teamId: string`\n\n- `objectType: 'deal' | 'identity' | 'ai_chat_thread' | 'ai_chat_message' | 'document' | 'action' | 'event'`\n\n- `objectId: string`\n\n- `team_group_id?: object[]`\n\n- `team_id?: object`\n\n- `user_id?: object[]`\n\n### Returns\n\n- `{ team_group_id?: object[]; team_id?: object; user_id?: object[]; }`\n\n  - `team_group_id?: object[]`\n  - `team_id?: object`\n  - `user_id?: object[]`\n\n### Example\n\n```typescript\nimport Micro from 'micro';\n\nconst client = new Micro();\n\nconst response = await client.prism.grant.updateGrant('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { objectType: 'deal' });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
        method: 'client.prism.grant.updateGrant',
        example:
          "import Micro from 'micro';\n\nconst client = new Micro({\n  teamID: 'My Team ID',\n  apiKey: process.env['MICRO_API_KEY'], // This is the default and can be omitted\n});\n\nconst response = await client.prism.grant.updateGrant('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {\n  objectType: 'deal',\n});\n\nconsole.log(response.team_group_id);",
      },
      python: {
        method: 'prism.grant.update_grant',
        example:
          'import os\nfrom micro import Micro\n\nclient = Micro(\n    api_key=os.environ.get("MICRO_API_KEY"),  # This is the default and can be omitted\n)\nresponse = client.prism.grant.update_grant(\n    object_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n    object_type="deal",\n)\nprint(response.team_group_id)',
      },
      go: {
        method: 'client.Prism.Grant.UpdateGrant',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/micro-go"\n\t"github.com/stainless-sdks/micro-go/option"\n)\n\nfunc main() {\n\tclient := micro.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t\toption.WithTeamID("My Team ID"),\n\t)\n\tresponse, err := client.Prism.Grant.UpdateGrant(\n\t\tcontext.TODO(),\n\t\tmicro.ObjectTypeDeal,\n\t\t"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n\t\tmicro.PrismGrantUpdateGrantParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response.TeamGroupID)\n}\n',
      },
      cli: {
  ...
  },
  {
    ...
    response: 'object',
    markdown:
      "## properties\n\n`client.prism.metadata.properties(teamId: string, objectType: 'deal' | 'identity' | 'ai_chat_thread' | 'ai_chat_message' | 'document' | 'action' | 'event', autofill?: boolean, crmId?: string, term?: string): object`\n\n**get** `/v2/prism/metadata/properties/{teamId}/{objectType}`\n\nGet metadata properties by object type\n\n### Parameters\n\n- `teamId: string`\n\n- `objectType: 'deal' | 'identity' | 'ai_chat_thread' | 'ai_chat_message' | 'document' | 'action' | 'event'`\n\n- `autofill?: boolean`\n\n- `crmId?: string`\n\n- `term?: string`\n\n### Returns\n\n- `object`\n\n### Example\n\n```typescript\nimport Micro from 'micro';\n\nconst client = new Micro();\n\nconst response = await client.prism.metadata.properties('deal');\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
      ...
      python: {
        ...
        example:
          'import os\nfrom micro import Micro\n\nclient = Micro(\n    api_key=os.environ.get("MICRO_API_KEY"),  # This is the default and can be omitted\n)\nresponse = client.prism.metadata.properties(\n    object_type="deal",\n)\nprint(response)',
      },
      go: {
        method: 'client.Prism.Metadata.Properties',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/micro-go"\n\t"github.com/stainless-sdks/micro-go/option"\n)\n\nfunc main() {\n\tclient := micro.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t\toption.WithTeamID("My Team ID"),\n\t)\n\tresponse, err := client.Prism.Metadata.Properties(\n\t\tcontext.TODO(),\n\t\tmicro.ObjectTypeDeal,\n\t\tmicro.PrismMetadataPropertiesParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response)\n}\n',
      },
      cli: {
  ...
  },
  {
    ...
    response: '{ id?: string; crm?: object; default?: object; extended?: object; }',
    markdown:
      "## create\n\n`client.contacts.create(teamId: string, id?: string, crm?: object, default?: object, extended?: object): { id?: string; crm?: object; default?: object; extended?: object; }`\n\n**post** `/v2/prism/{teamId}/contact`\n\nCreate object\n\n### Parameters\n\n- `teamId: string`\n\n- `id?: string`\n\n- `crm?: object`\n\n- `default?: object`\n  Properties keyed by property slug. Values can be strings, numbers, booleans, arrays, or null.\n\n- `extended?: object`\n\n### Returns\n\n- `{ id?: string; crm?: object; default?: object; extended?: object; }`\n\n  - `id?: string`\n  - `crm?: object`\n  - `default?: object`\n  - `extended?: object`\n\n### Example\n\n```typescript\nimport Micro from 'micro';\n\nconst client = new Micro();\n\nconst prismObjectProperties = await client.contacts.create();\n\nconsole.log(prismObjectProperties);\n```",
    perLanguage: {
      typescript: {
      ...
      python: {
        ...
        example:
          'import os\nfrom micro import Micro\n\nclient = Micro(\n    api_key=os.environ.get("MICRO_API_KEY"),  # This is the default and can be omitted\n)\nprism_object_properties = client.contacts.create()\nprint(prism_object_properties.id)',
      },
      go: {
        method: 'client.Contacts.New',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/micro-go"\n\t"github.com/stainless-sdks/micro-go/option"\n)\n\nfunc main() {\n\tclient := micro.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t\toption.WithTeamID("My Team ID"),\n\t)\n\tprismObjectProperties, err := client.Contacts.New(context.TODO(), micro.ContactNewParams{\n\t\tPrismObjectProperties: micro.PrismObjectPropertiesParam{},\n\t})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", prismObjectProperties.ID)\n}\n',
      },
      cli: {
        method: 'contacts create',
        example:
  ...
  },
  {
    ...
    response: '{ id?: string; crm?: object; default?: object; extended?: object; }',
    markdown:
      "## update\n\n`client.contacts.update(teamId: string, contactId: string, id?: string, crm?: object, default?: object, extended?: object): { id?: string; crm?: object; default?: object; extended?: object; }`\n\n**patch** `/v2/prism/{teamId}/contact/{contactId}`\n\nPatch object\n\n### Parameters\n\n- `teamId: string`\n\n- `contactId: string`\n\n- `id?: string`\n\n- `crm?: object`\n\n- `default?: object`\n  Properties keyed by property slug. Values can be strings, numbers, booleans, arrays, or null.\n\n- `extended?: object`\n\n### Returns\n\n- `{ id?: string; crm?: object; default?: object; extended?: object; }`\n\n  - `id?: string`\n  - `crm?: object`\n  - `default?: object`\n  - `extended?: object`\n\n### Example\n\n```typescript\nimport Micro from 'micro';\n\nconst client = new Micro();\n\nconst prismObjectProperties = await client.contacts.update('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');\n\nconsole.log(prismObjectProperties);\n```",
    perLanguage: {
      typescript: {
      ...
      python: {
        ...
        example:
          'import os\nfrom micro import Micro\n\nclient = Micro(\n    api_key=os.environ.get("MICRO_API_KEY"),  # This is the default and can be omitted\n)\nprism_object_properties = client.contacts.update(\n    contact_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n)\nprint(prism_object_properties.id)',
      },
      go: {
        method: 'client.Contacts.Update',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/micro-go"\n\t"github.com/stainless-sdks/micro-go/option"\n)\n\nfunc main() {\n\tclient := micro.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t\toption.WithTeamID("My Team ID"),\n\t)\n\tprismObjectProperties, err := client.Contacts.Update(\n\t\tcontext.TODO(),\n\t\t"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n\t\tmicro.ContactUpdateParams{\n\t\t\tPrismObjectProperties: micro.PrismObjectPropertiesParam{},\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", prismObjectProperties.ID)\n}\n',
      },
      cli: {
        method: 'contacts update',
        example:
  ...
  },
  {
    ...
    response: '{ data?: object[]; total?: number; }',
    markdown:
      "## list\n\n`client.contacts.list(teamId: string, query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }, id?: string | string[], boxes?: string[], deleted?: boolean, sources?: string[]): { data?: object[]; total?: number; }`\n\n**post** `/v2/prism/query/{teamId}/contact`\n\nQuery v2\n\n### Parameters\n\n- `teamId: string`\n\n- `query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }`\n  - `select: string[]`\n    Property slugs to select. Use dot notation for relationships (e.g. attendee.contact.first_name)\n  - `combinator?: 'AND' | 'OR'`\n    Logical operator for combining filters\n  - `crm_id?: string`\n  - `filter?: object[]`\n    Filters as [{ slug: { operator: value } }]. For select/multiselect properties, values must be option slugs\n  - `limit?: number`\n  - `page?: number`\n  - `sort?: object[]`\n    Sort order as [{ slug: direction }]. Array order determines sort priority\n\n- `id?: string | string[]`\n\n- `boxes?: string[]`\n\n- `deleted?: boolean`\n\n- `sources?: string[]`\n\n### Returns\n\n- `{ data?: object[]; total?: number; }`\n\n  - `data?: object[]`\n  - `total?: number`\n\n### Example\n\n```typescript\nimport Micro from 'micro';\n\nconst client = new Micro();\n\nconst contacts = await client.contacts.list({ query: { select: ['string'] } });\n\nconsole.log(contacts);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response: '{ id?: string; crm?: object; default?: object; extended?: object; }',
    markdown:
      "## create\n\n`client.organizations.create(teamId: string, id?: string, crm?: object, default?: object, extended?: object): { id?: string; crm?: object; default?: object; extended?: object; }`\n\n**post** `/v2/prism/{teamId}/organization`\n\nCreate object\n\n### Parameters\n\n- `teamId: string`\n\n- `id?: string`\n\n- `crm?: object`\n\n- `default?: object`\n  Properties keyed by property slug. Values can be strings, numbers, booleans, arrays, or null.\n\n- `extended?: object`\n\n### Returns\n\n- `{ id?: string; crm?: object; default?: object; extended?: object; }`\n\n  - `id?: string`\n  - `crm?: object`\n  - `default?: object`\n  - `extended?: object`\n\n### Example\n\n```typescript\nimport Micro from 'micro';\n\nconst client = new Micro();\n\nconst prismObjectProperties = await client.organizations.create();\n\nconsole.log(prismObjectProperties);\n```",
    perLanguage: {
      typescript: {
      ...
      python: {
        ...
        example:
          'import os\nfrom micro import Micro\n\nclient = Micro(\n    api_key=os.environ.get("MICRO_API_KEY"),  # This is the default and can be omitted\n)\nprism_object_properties = client.organizations.create()\nprint(prism_object_properties.id)',
      },
      go: {
        method: 'client.Organizations.New',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/micro-go"\n\t"github.com/stainless-sdks/micro-go/option"\n)\n\nfunc main() {\n\tclient := micro.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t\toption.WithTeamID("My Team ID"),\n\t)\n\tprismObjectProperties, err := client.Organizations.New(context.TODO(), micro.OrganizationNewParams{\n\t\tPrismObjectProperties: micro.PrismObjectPropertiesParam{},\n\t})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", prismObjectProperties.ID)\n}\n',
      },
      cli: {
        method: 'organizations create',
        example:
  ...
  },
  {
    ...
    response: '{ id?: string; crm?: object; default?: object; extended?: object; }',
    markdown:
      "## update\n\n`client.organizations.update(teamId: string, organizationId: string, id?: string, crm?: object, default?: object, extended?: object): { id?: string; crm?: object; default?: object; extended?: object; }`\n\n**patch** `/v2/prism/{teamId}/organization/{organizationId}`\n\nPatch object\n\n### Parameters\n\n- `teamId: string`\n\n- `organizationId: string`\n\n- `id?: string`\n\n- `crm?: object`\n\n- `default?: object`\n  Properties keyed by property slug. Values can be strings, numbers, booleans, arrays, or null.\n\n- `extended?: object`\n\n### Returns\n\n- `{ id?: string; crm?: object; default?: object; extended?: object; }`\n\n  - `id?: string`\n  - `crm?: object`\n  - `default?: object`\n  - `extended?: object`\n\n### Example\n\n```typescript\nimport Micro from 'micro';\n\nconst client = new Micro();\n\nconst prismObjectProperties = await client.organizations.update('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');\n\nconsole.log(prismObjectProperties);\n```",
    perLanguage: {
      typescript: {
        method: 'client.organizations.update',
        example:
          "import Micro from 'micro';\n\nconst client = new Micro({\n  teamID: 'My Team ID',\n  apiKey: process.env['MICRO_API_KEY'], // This is the default and can be omitted\n});\n\nconst prismObjectProperties = await client.organizations.update(\n  '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',\n);\n\nconsole.log(prismObjectProperties.id);",
      },
      python: {
        method: 'organizations.update',
        example:
          'import os\nfrom micro import Micro\n\nclient = Micro(\n    api_key=os.environ.get("MICRO_API_KEY"),  # This is the default and can be omitted\n)\nprism_object_properties = client.organizations.update(\n    organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n)\nprint(prism_object_properties.id)',
      },
      go: {
        method: 'client.Organizations.Update',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/micro-go"\n\t"github.com/stainless-sdks/micro-go/option"\n)\n\nfunc main() {\n\tclient := micro.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t\toption.WithTeamID("My Team ID"),\n\t)\n\tprismObjectProperties, err := client.Organizations.Update(\n\t\tcontext.TODO(),\n\t\t"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n\t\tmicro.OrganizationUpdateParams{\n\t\t\tPrismObjectProperties: micro.PrismObjectPropertiesParam{},\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", prismObjectProperties.ID)\n}\n',
      },
      cli: {
        method: 'organizations update',
        example:
  ...
  },
  {
    ...
    response: '{ data?: object[]; total?: number; }',
    markdown:
      "## list\n\n`client.organizations.list(teamId: string, query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }, id?: string | string[], boxes?: string[], deleted?: boolean, sources?: string[]): { data?: object[]; total?: number; }`\n\n**post** `/v2/prism/query/{teamId}/organization`\n\nQuery v2\n\n### Parameters\n\n- `teamId: string`\n\n- `query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }`\n  - `select: string[]`\n    Property slugs to select. Use dot notation for relationships (e.g. attendee.contact.first_name)\n  - `combinator?: 'AND' | 'OR'`\n    Logical operator for combining filters\n  - `crm_id?: string`\n  - `filter?: object[]`\n    Filters as [{ slug: { operator: value } }]. For select/multiselect properties, values must be option slugs\n  - `limit?: number`\n  - `page?: number`\n  - `sort?: object[]`\n    Sort order as [{ slug: direction }]. Array order determines sort priority\n\n- `id?: string | string[]`\n\n- `boxes?: string[]`\n\n- `deleted?: boolean`\n\n- `sources?: string[]`\n\n### Returns\n\n- `{ data?: object[]; total?: number; }`\n\n  - `data?: object[]`\n  - `total?: number`\n\n### Example\n\n```typescript\nimport Micro from 'micro';\n\nconst client = new Micro();\n\nconst organizations = await client.organizations.list({ query: { select: ['string'] } });\n\nconsole.log(organizations);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response: '{ id?: string; crm?: object; default?: object; extended?: object; }',
    markdown:
      "## create\n\n`client.identities.create(teamId: string, id?: string, crm?: object, default?: object, extended?: object): { id?: string; crm?: object; default?: object; extended?: object; }`\n\n**post** `/v2/prism/{teamId}/identity`\n\nCreate object\n\n### Parameters\n\n- `teamId: string`\n\n- `id?: string`\n\n- `crm?: object`\n\n- `default?: object`\n  Properties keyed by property slug. Values can be strings, numbers, booleans, arrays, or null.\n\n- `extended?: object`\n\n### Returns\n\n- `{ id?: string; crm?: object; default?: object; extended?: object; }`\n\n  - `id?: string`\n  - `crm?: object`\n  - `default?: object`\n  - `extended?: object`\n\n### Example\n\n```typescript\nimport Micro from 'micro';\n\nconst client = new Micro();\n\nconst prismObjectProperties = await client.identities.create();\n\nconsole.log(prismObjectProperties);\n```",
    perLanguage: {
      typescript: {
      ...
      python: {
        ...
        example:
          'import os\nfrom micro import Micro\n\nclient = Micro(\n    api_key=os.environ.get("MICRO_API_KEY"),  # This is the default and can be omitted\n)\nprism_object_properties = client.identities.create()\nprint(prism_object_properties.id)',
      },
      go: {
        method: 'client.Identities.New',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/micro-go"\n\t"github.com/stainless-sdks/micro-go/option"\n)\n\nfunc main() {\n\tclient := micro.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t\toption.WithTeamID("My Team ID"),\n\t)\n\tprismObjectProperties, err := client.Identities.New(context.TODO(), micro.IdentityNewParams{\n\t\tPrismObjectProperties: micro.PrismObjectPropertiesParam{},\n\t})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", prismObjectProperties.ID)\n}\n',
      },
      cli: {
        method: 'identities create',
        example:
  ...
  },
  {
    ...
    response: '{ id?: string; crm?: object; default?: object; extended?: object; }',
    markdown:
      "## update\n\n`client.identities.update(teamId: string, identityId: string, id?: string, crm?: object, default?: object, extended?: object): { id?: string; crm?: object; default?: object; extended?: object; }`\n\n**patch** `/v2/prism/{teamId}/identity/{identityId}`\n\nPatch object\n\n### Parameters\n\n- `teamId: string`\n\n- `identityId: string`\n\n- `id?: string`\n\n- `crm?: object`\n\n- `default?: object`\n  Properties keyed by property slug. Values can be strings, numbers, booleans, arrays, or null.\n\n- `extended?: object`\n\n### Returns\n\n- `{ id?: string; crm?: object; default?: object; extended?: object; }`\n\n  - `id?: string`\n  - `crm?: object`\n  - `default?: object`\n  - `extended?: object`\n\n### Example\n\n```typescript\nimport Micro from 'micro';\n\nconst client = new Micro();\n\nconst prismObjectProperties = await client.identities.update('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');\n\nconsole.log(prismObjectProperties);\n```",
    perLanguage: {
      typescript: {
        method: 'client.identities.update',
        example:
          "import Micro from 'micro';\n\nconst client = new Micro({\n  teamID: 'My Team ID',\n  apiKey: process.env['MICRO_API_KEY'], // This is the default and can be omitted\n});\n\nconst prismObjectProperties = await client.identities.update(\n  '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',\n);\n\nconsole.log(prismObjectProperties.id);",
      },
      python: {
        method: 'identities.update',
        example:
          'import os\nfrom micro import Micro\n\nclient = Micro(\n    api_key=os.environ.get("MICRO_API_KEY"),  # This is the default and can be omitted\n)\nprism_object_properties = client.identities.update(\n    identity_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n)\nprint(prism_object_properties.id)',
      },
      go: {
        method: 'client.Identities.Update',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/micro-go"\n\t"github.com/stainless-sdks/micro-go/option"\n)\n\nfunc main() {\n\tclient := micro.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t\toption.WithTeamID("My Team ID"),\n\t)\n\tprismObjectProperties, err := client.Identities.Update(\n\t\tcontext.TODO(),\n\t\t"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n\t\tmicro.IdentityUpdateParams{\n\t\t\tPrismObjectProperties: micro.PrismObjectPropertiesParam{},\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", prismObjectProperties.ID)\n}\n',
      },
      cli: {
        method: 'identities update',
        example:
  ...
  },
  {
    ...
    response: '{ data?: object[]; total?: number; }',
    markdown:
      "## list\n\n`client.identities.list(teamId: string, query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }, id?: string | string[], boxes?: string[], deleted?: boolean, sources?: string[]): { data?: object[]; total?: number; }`\n\n**post** `/v2/prism/query/{teamId}/identity`\n\nQuery v2\n\n### Parameters\n\n- `teamId: string`\n\n- `query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }`\n  - `select: string[]`\n    Property slugs to select. Use dot notation for relationships (e.g. attendee.contact.first_name)\n  - `combinator?: 'AND' | 'OR'`\n    Logical operator for combining filters\n  - `crm_id?: string`\n  - `filter?: object[]`\n    Filters as [{ slug: { operator: value } }]. For select/multiselect properties, values must be option slugs\n  - `limit?: number`\n  - `page?: number`\n  - `sort?: object[]`\n    Sort order as [{ slug: direction }]. Array order determines sort priority\n\n- `id?: string | string[]`\n\n- `boxes?: string[]`\n\n- `deleted?: boolean`\n\n- `sources?: string[]`\n\n### Returns\n\n- `{ data?: object[]; total?: number; }`\n\n  - `data?: object[]`\n  - `total?: number`\n\n### Example\n\n```typescript\nimport Micro from 'micro';\n\nconst client = new Micro();\n\nconst identities = await client.identities.list({ query: { select: ['string'] } });\n\nconsole.log(identities);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response: '{ id?: string; crm?: object; default?: object; extended?: object; }',
    markdown:
      "## create\n\n`client.deals.create(teamId: string, id?: string, crm?: object, default?: object, extended?: object): { id?: string; crm?: object; default?: object; extended?: object; }`\n\n**post** `/v2/prism/{teamId}/deal`\n\nCreate object\n\n### Parameters\n\n- `teamId: string`\n\n- `id?: string`\n\n- `crm?: object`\n\n- `default?: object`\n  Properties keyed by property slug. Values can be strings, numbers, booleans, arrays, or null.\n\n- `extended?: object`\n\n### Returns\n\n- `{ id?: string; crm?: object; default?: object; extended?: object; }`\n\n  - `id?: string`\n  - `crm?: object`\n  - `default?: object`\n  - `extended?: object`\n\n### Example\n\n```typescript\nimport Micro from 'micro';\n\nconst client = new Micro();\n\nconst prismObjectProperties = await client.deals.create();\n\nconsole.log(prismObjectProperties);\n```",
    perLanguage: {
      typescript: {
      ...
      python: {
        method: 'deals.create',
        example:
          'import os\nfrom micro import Micro\n\nclient = Micro(\n    api_key=os.environ.get("MICRO_API_KEY"),  # This is the default and can be omitted\n)\nprism_object_properties = client.deals.create()\nprint(prism_object_properties.id)',
      },
      go: {
        method: 'client.Deals.New',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/micro-go"\n\t"github.com/stainless-sdks/micro-go/option"\n)\n\nfunc main() {\n\tclient := micro.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t\toption.WithTeamID("My Team ID"),\n\t)\n\tprismObjectProperties, err := client.Deals.New(context.TODO(), micro.DealNewParams{\n\t\tPrismObjectProperties: micro.PrismObjectPropertiesParam{},\n\t})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", prismObjectProperties.ID)\n}\n',
      },
      cli: {
        method: 'deals create',
        example:
  ...
  },
  {
    ...
    response: '{ id?: string; crm?: object; default?: object; extended?: object; }',
    markdown:
      "## update\n\n`client.deals.update(teamId: string, dealId: string, id?: string, crm?: object, default?: object, extended?: object): { id?: string; crm?: object; default?: object; extended?: object; }`\n\n**patch** `/v2/prism/{teamId}/deal/{dealId}`\n\nPatch object\n\n### Parameters\n\n- `teamId: string`\n\n- `dealId: string`\n\n- `id?: string`\n\n- `crm?: object`\n\n- `default?: object`\n  Properties keyed by property slug. Values can be strings, numbers, booleans, arrays, or null.\n\n- `extended?: object`\n\n### Returns\n\n- `{ id?: string; crm?: object; default?: object; extended?: object; }`\n\n  - `id?: string`\n  - `crm?: object`\n  - `default?: object`\n  - `extended?: object`\n\n### Example\n\n```typescript\nimport Micro from 'micro';\n\nconst client = new Micro();\n\nconst prismObjectProperties = await client.deals.update('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');\n\nconsole.log(prismObjectProperties);\n```",
    perLanguage: {
      typescript: {
      ...
      python: {
        method: 'deals.update',
        example:
          'import os\nfrom micro import Micro\n\nclient = Micro(\n    api_key=os.environ.get("MICRO_API_KEY"),  # This is the default and can be omitted\n)\nprism_object_properties = client.deals.update(\n    deal_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n)\nprint(prism_object_properties.id)',
      },
      go: {
        method: 'client.Deals.Update',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/micro-go"\n\t"github.com/stainless-sdks/micro-go/option"\n)\n\nfunc main() {\n\tclient := micro.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t\toption.WithTeamID("My Team ID"),\n\t)\n\tprismObjectProperties, err := client.Deals.Update(\n\t\tcontext.TODO(),\n\t\t"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n\t\tmicro.DealUpdateParams{\n\t\t\tPrismObjectProperties: micro.PrismObjectPropertiesParam{},\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", prismObjectProperties.ID)\n}\n',
      },
      cli: {
        method: 'deals update',
        example:
  ...
  },
  {
    ...
    response: '{ data?: object[]; total?: number; }',
    markdown:
      "## list\n\n`client.deals.list(teamId: string, query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }, id?: string | string[], boxes?: string[], deleted?: boolean, sources?: string[]): { data?: object[]; total?: number; }`\n\n**post** `/v2/prism/query/{teamId}/deal`\n\nQuery v2\n\n### Parameters\n\n- `teamId: string`\n\n- `query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }`\n  - `select: string[]`\n    Property slugs to select. Use dot notation for relationships (e.g. attendee.contact.first_name)\n  - `combinator?: 'AND' | 'OR'`\n    Logical operator for combining filters\n  - `crm_id?: string`\n  - `filter?: object[]`\n    Filters as [{ slug: { operator: value } }]. For select/multiselect properties, values must be option slugs\n  - `limit?: number`\n  - `page?: number`\n  - `sort?: object[]`\n    Sort order as [{ slug: direction }]. Array order determines sort priority\n\n- `id?: string | string[]`\n\n- `boxes?: string[]`\n\n- `deleted?: boolean`\n\n- `sources?: string[]`\n\n### Returns\n\n- `{ data?: object[]; total?: number; }`\n\n  - `data?: object[]`\n  - `total?: number`\n\n### Example\n\n```typescript\nimport Micro from 'micro';\n\nconst client = new Micro();\n\nconst deals = await client.deals.list({ query: { select: ['string'] } });\n\nconsole.log(deals);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response: '{ id?: string; crm?: object; default?: object; extended?: object; }',
    markdown:
      "## create\n\n`client.actions.create(teamId: string, id?: string, crm?: object, default?: object, extended?: object): { id?: string; crm?: object; default?: object; extended?: object; }`\n\n**post** `/v2/prism/{teamId}/action`\n\nCreate object\n\n### Parameters\n\n- `teamId: string`\n\n- `id?: string`\n\n- `crm?: object`\n\n- `default?: object`\n  Properties keyed by property slug. Values can be strings, numbers, booleans, arrays, or null.\n\n- `extended?: object`\n\n### Returns\n\n- `{ id?: string; crm?: object; default?: object; extended?: object; }`\n\n  - `id?: string`\n  - `crm?: object`\n  - `default?: object`\n  - `extended?: object`\n\n### Example\n\n```typescript\nimport Micro from 'micro';\n\nconst client = new Micro();\n\nconst prismObjectProperties = await client.actions.create();\n\nconsole.log(prismObjectProperties);\n```",
    perLanguage: {
      typescript: {
      ...
      python: {
        ...
        example:
          'import os\nfrom micro import Micro\n\nclient = Micro(\n    api_key=os.environ.get("MICRO_API_KEY"),  # This is the default and can be omitted\n)\nprism_object_properties = client.actions.create()\nprint(prism_object_properties.id)',
      },
      go: {
        method: 'client.Actions.New',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/micro-go"\n\t"github.com/stainless-sdks/micro-go/option"\n)\n\nfunc main() {\n\tclient := micro.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t\toption.WithTeamID("My Team ID"),\n\t)\n\tprismObjectProperties, err := client.Actions.New(context.TODO(), micro.ActionNewParams{\n\t\tPrismObjectProperties: micro.PrismObjectPropertiesParam{},\n\t})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", prismObjectProperties.ID)\n}\n',
      },
      cli: {
        method: 'actions create',
        example:
  ...
  },
  {
    ...
    response: '{ id?: string; crm?: object; default?: object; extended?: object; }',
    markdown:
      "## update\n\n`client.actions.update(teamId: string, actionId: string, id?: string, crm?: object, default?: object, extended?: object): { id?: string; crm?: object; default?: object; extended?: object; }`\n\n**patch** `/v2/prism/{teamId}/action/{actionId}`\n\nPatch object\n\n### Parameters\n\n- `teamId: string`\n\n- `actionId: string`\n\n- `id?: string`\n\n- `crm?: object`\n\n- `default?: object`\n  Properties keyed by property slug. Values can be strings, numbers, booleans, arrays, or null.\n\n- `extended?: object`\n\n### Returns\n\n- `{ id?: string; crm?: object; default?: object; extended?: object; }`\n\n  - `id?: string`\n  - `crm?: object`\n  - `default?: object`\n  - `extended?: object`\n\n### Example\n\n```typescript\nimport Micro from 'micro';\n\nconst client = new Micro();\n\nconst prismObjectProperties = await client.actions.update('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');\n\nconsole.log(prismObjectProperties);\n```",
    perLanguage: {
      typescript: {
      ...
      python: {
        ...
        example:
          'import os\nfrom micro import Micro\n\nclient = Micro(\n    api_key=os.environ.get("MICRO_API_KEY"),  # This is the default and can be omitted\n)\nprism_object_properties = client.actions.update(\n    action_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n)\nprint(prism_object_properties.id)',
      },
      go: {
        method: 'client.Actions.Update',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/micro-go"\n\t"github.com/stainless-sdks/micro-go/option"\n)\n\nfunc main() {\n\tclient := micro.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t\toption.WithTeamID("My Team ID"),\n\t)\n\tprismObjectProperties, err := client.Actions.Update(\n\t\tcontext.TODO(),\n\t\t"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n\t\tmicro.ActionUpdateParams{\n\t\t\tPrismObjectProperties: micro.PrismObjectPropertiesParam{},\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", prismObjectProperties.ID)\n}\n',
      },
      cli: {
        method: 'actions update',
        example:
  ...
  },
  {
    ...
    response: '{ data?: object[]; total?: number; }',
    markdown:
      "## list\n\n`client.actions.list(teamId: string, query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }, id?: string | string[], boxes?: string[], deleted?: boolean, sources?: string[]): { data?: object[]; total?: number; }`\n\n**post** `/v2/prism/query/{teamId}/action`\n\nQuery v2\n\n### Parameters\n\n- `teamId: string`\n\n- `query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }`\n  - `select: string[]`\n    Property slugs to select. Use dot notation for relationships (e.g. attendee.contact.first_name)\n  - `combinator?: 'AND' | 'OR'`\n    Logical operator for combining filters\n  - `crm_id?: string`\n  - `filter?: object[]`\n    Filters as [{ slug: { operator: value } }]. For select/multiselect properties, values must be option slugs\n  - `limit?: number`\n  - `page?: number`\n  - `sort?: object[]`\n    Sort order as [{ slug: direction }]. Array order determines sort priority\n\n- `id?: string | string[]`\n\n- `boxes?: string[]`\n\n- `deleted?: boolean`\n\n- `sources?: string[]`\n\n### Returns\n\n- `{ data?: object[]; total?: number; }`\n\n  - `data?: object[]`\n  - `total?: number`\n\n### Example\n\n```typescript\nimport Micro from 'micro';\n\nconst client = new Micro();\n\nconst actions = await client.actions.list({ query: { select: ['string'] } });\n\nconsole.log(actions);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response: '{ data?: object[]; total?: number; }',
    markdown:
      "## list\n\n`client.events.list(teamId: string, query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }, id?: string | string[], boxes?: string[], deleted?: boolean, sources?: string[]): { data?: object[]; total?: number; }`\n\n**post** `/v2/prism/query/{teamId}/event`\n\nQuery v2\n\n### Parameters\n\n- `teamId: string`\n\n- `query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }`\n  - `select: string[]`\n    Property slugs to select. Use dot notation for relationships (e.g. attendee.contact.first_name)\n  - `combinator?: 'AND' | 'OR'`\n    Logical operator for combining filters\n  - `crm_id?: string`\n  - `filter?: object[]`\n    Filters as [{ slug: { operator: value } }]. For select/multiselect properties, values must be option slugs\n  - `limit?: number`\n  - `page?: number`\n  - `sort?: object[]`\n    Sort order as [{ slug: direction }]. Array order determines sort priority\n\n- `id?: string | string[]`\n\n- `boxes?: string[]`\n\n- `deleted?: boolean`\n\n- `sources?: string[]`\n\n### Returns\n\n- `{ data?: object[]; total?: number; }`\n\n  - `data?: object[]`\n  - `total?: number`\n\n### Example\n\n```typescript\nimport Micro from 'micro';\n\nconst client = new Micro();\n\nconst events = await client.events.list({ query: { select: ['string'] } });\n\nconsole.log(events);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response: '{ id?: string; crm?: object; default?: object; extended?: object; }',
    markdown:
      "## create\n\n`client.documents.create(teamId: string, id?: string, crm?: object, default?: object, extended?: object): { id?: string; crm?: object; default?: object; extended?: object; }`\n\n**post** `/v2/prism/{teamId}/document`\n\nCreate object\n\n### Parameters\n\n- `teamId: string`\n\n- `id?: string`\n\n- `crm?: object`\n\n- `default?: object`\n  Properties keyed by property slug. Values can be strings, numbers, booleans, arrays, or null.\n\n- `extended?: object`\n\n### Returns\n\n- `{ id?: string; crm?: object; default?: object; extended?: object; }`\n\n  - `id?: string`\n  - `crm?: object`\n  - `default?: object`\n  - `extended?: object`\n\n### Example\n\n```typescript\nimport Micro from 'micro';\n\nconst client = new Micro();\n\nconst prismObjectProperties = await client.documents.create();\n\nconsole.log(prismObjectProperties);\n```",
    perLanguage: {
      typescript: {
      ...
      python: {
        ...
        example:
          'import os\nfrom micro import Micro\n\nclient = Micro(\n    api_key=os.environ.get("MICRO_API_KEY"),  # This is the default and can be omitted\n)\nprism_object_properties = client.documents.create()\nprint(prism_object_properties.id)',
      },
      go: {
        method: 'client.Documents.New',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/micro-go"\n\t"github.com/stainless-sdks/micro-go/option"\n)\n\nfunc main() {\n\tclient := micro.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t\toption.WithTeamID("My Team ID"),\n\t)\n\tprismObjectProperties, err := client.Documents.New(context.TODO(), micro.DocumentNewParams{\n\t\tPrismObjectProperties: micro.PrismObjectPropertiesParam{},\n\t})\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", prismObjectProperties.ID)\n}\n',
      },
      cli: {
        method: 'documents create',
        example:
  ...
  },
  {
    ...
    response: '{ id?: string; crm?: object; default?: object; extended?: object; }',
    markdown:
      "## update\n\n`client.documents.update(teamId: string, documentId: string, id?: string, crm?: object, default?: object, extended?: object): { id?: string; crm?: object; default?: object; extended?: object; }`\n\n**patch** `/v2/prism/{teamId}/document/{documentId}`\n\nPatch object\n\n### Parameters\n\n- `teamId: string`\n\n- `documentId: string`\n\n- `id?: string`\n\n- `crm?: object`\n\n- `default?: object`\n  Properties keyed by property slug. Values can be strings, numbers, booleans, arrays, or null.\n\n- `extended?: object`\n\n### Returns\n\n- `{ id?: string; crm?: object; default?: object; extended?: object; }`\n\n  - `id?: string`\n  - `crm?: object`\n  - `default?: object`\n  - `extended?: object`\n\n### Example\n\n```typescript\nimport Micro from 'micro';\n\nconst client = new Micro();\n\nconst prismObjectProperties = await client.documents.update('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');\n\nconsole.log(prismObjectProperties);\n```",
    perLanguage: {
      typescript: {
      ...
      python: {
        ...
        example:
          'import os\nfrom micro import Micro\n\nclient = Micro(\n    api_key=os.environ.get("MICRO_API_KEY"),  # This is the default and can be omitted\n)\nprism_object_properties = client.documents.update(\n    document_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n)\nprint(prism_object_properties.id)',
      },
      go: {
        method: 'client.Documents.Update',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stainless-sdks/micro-go"\n\t"github.com/stainless-sdks/micro-go/option"\n)\n\nfunc main() {\n\tclient := micro.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t\toption.WithTeamID("My Team ID"),\n\t)\n\tprismObjectProperties, err := client.Documents.Update(\n\t\tcontext.TODO(),\n\t\t"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n\t\tmicro.DocumentUpdateParams{\n\t\t\tPrismObjectProperties: micro.PrismObjectPropertiesParam{},\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", prismObjectProperties.ID)\n}\n',
      },
      cli: {
        method: 'documents update',
        example:
  ...
  },
  {
    ...
    response: '{ data?: object[]; total?: number; }',
    markdown:
      "## list\n\n`client.documents.list(teamId: string, query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }, id?: string | string[], boxes?: string[], deleted?: boolean, sources?: string[]): { data?: object[]; total?: number; }`\n\n**post** `/v2/prism/query/{teamId}/document`\n\nQuery v2\n\n### Parameters\n\n- `teamId: string`\n\n- `query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }`\n  - `select: string[]`\n    Property slugs to select. Use dot notation for relationships (e.g. attendee.contact.first_name)\n  - `combinator?: 'AND' | 'OR'`\n    Logical operator for combining filters\n  - `crm_id?: string`\n  - `filter?: object[]`\n    Filters as [{ slug: { operator: value } }]. For select/multiselect properties, values must be option slugs\n  - `limit?: number`\n  - `page?: number`\n  - `sort?: object[]`\n    Sort order as [{ slug: direction }]. Array order determines sort priority\n\n- `id?: string | string[]`\n\n- `boxes?: string[]`\n\n- `deleted?: boolean`\n\n- `sources?: string[]`\n\n### Returns\n\n- `{ data?: object[]; total?: number; }`\n\n  - `data?: object[]`\n  - `total?: number`\n\n### Example\n\n```typescript\nimport Micro from 'micro';\n\nconst client = new Micro();\n\nconst documents = await client.documents.list({ query: { select: ['string'] } });\n\nconsole.log(documents);\n```",
    perLanguage: {
      typescript: {
