...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/metadata/properties/$TEAM_ID/$OBJECT_TYPE \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/contact \\\n    -X POST \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/contact/$CONTACT_ID \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
    ...
    response: '{ id: string; crm?: object; default?: object; extended?: object; }',
    markdown:
      "## update\n\n`client.prism.objects.contacts.update(teamId: string, contactId: string, id?: string, crm?: object, default?: object, extended?: object): { id: string; crm?: object; default?: object; extended?: object; }`\n\n**patch** `/v2/prism/{teamId}/contact/{contactId}`\n\nPatch object\n\n### Parameters\n\n- `teamId: string`\n\n- `contactId: string`\n\n- `id?: string`\n\n- `crm?: object`\n\n- `default?: object`\n  Properties keyed by property slug. Values can be strings, numbers, booleans, arrays, or null. For select/multiselect properties, values may be option slugs or option UUIDs on write; option slugs are returned on read.\n\n- `extended?: object`\n\n### Returns\n\n- `{ id: string; crm?: object; default?: object; extended?: object; }`\n  Object returned by reads (get/create/patch/restore). id is always present.\n\n  - `id: string`\n  - `crm?: object`\n  - `default?: object`\n  - `extended?: object`\n\n### Example\n\n```typescript\nimport Micro from '@micro-so/sdk';\n\nconst client = new Micro();\n\nconst contact = await client.prism.objects.contacts.update('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');\n\nconsole.log(contact);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      '{ data: { id: string; crm?: object; default?: object; extended?: object; }[]; has_more?: boolean; }',
    markdown:
      "## query\n\n`client.prism.objects.contacts.query(teamId: string, query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }, id?: string | string[], boxes?: string[], deleted?: boolean, sources?: string[]): { data: object[]; has_more?: boolean; }`\n\n**post** `/v2/prism/query/{teamId}/contact`\n\nQuery\n\n### Parameters\n\n- `teamId: string`\n\n- `query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }`\n  - `select: string[]`\n    Property slugs to select. Use dot notation for relationships (e.g. attendee.contact.first_name)\n  - `combinator?: 'AND' | 'OR'`\n    Logical operator for combining filters\n  - `crm_id?: string`\n  - `filter?: object[]`\n    Filters as [{ slug: { operator: value } }]. For select/multiselect properties, values may be option slugs or option UUIDs.\n  - `limit?: number`\n  - `page?: number`\n  - `sort?: object[]`\n    Sort order as [{ slug: direction }]. Array order determines sort priority\n\n- `id?: string | string[]`\n\n- `boxes?: string[]`\n\n- `deleted?: boolean`\n\n- `sources?: string[]`\n\n### Returns\n\n- `{ data: { id: string; crm?: object; default?: object; extended?: object; }[]; has_more?: boolean; }`\n\n  - `data: { id: string; crm?: object; default?: object; extended?: object; }[]`\n  - `has_more?: boolean`\n\n### Example\n\n```typescript\nimport Micro from '@micro-so/sdk';\n\nconst client = new Micro();\n\nconst response = await client.prism.objects.contacts.query({ query: { select: ['string'] } });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/query/$TEAM_ID/contact \\\n    -H \'Content-Type: application/json\' \\\n    -H "x-api-key: $MICRO_API_KEY" \\\n    -d \'{\n          "query": {\n            "select": [\n              "string"\n            ]\n          }\n        }\'',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/contact/import \\\n    -H \'Content-Type: application/json\' \\\n    -H "x-api-key: $MICRO_API_KEY" \\\n    -d \'{\n          "objects": [\n            {}\n          ]\n        }\'',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/contact/$CONTACT_ID/duplicate \\\n    -X POST \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/contact/$CONTACT_ID/restore \\\n    -X POST \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
    ...
    response: '{ id: string; crm?: object; default?: object; extended?: object; }',
    markdown:
      "## create\n\n`client.prism.objects.organizations.create(teamId: string, id?: string, crm?: object, default?: object, extended?: object): { id: string; crm?: object; default?: object; extended?: object; }`\n\n**post** `/v2/prism/{teamId}/organization`\n\nCreate object\n\n### Parameters\n\n- `teamId: string`\n\n- `id?: string`\n\n- `crm?: object`\n\n- `default?: object`\n  Properties keyed by property slug. Values can be strings, numbers, booleans, arrays, or null. For select/multiselect properties, values may be option slugs or option UUIDs on write; option slugs are returned on read.\n\n- `extended?: object`\n\n### Returns\n\n- `{ id: string; crm?: object; default?: object; extended?: object; }`\n  Object returned by reads (get/create/patch/restore). id is always present.\n\n  - `id: string`\n  - `crm?: object`\n  - `default?: object`\n  - `extended?: object`\n\n### Example\n\n```typescript\nimport Micro from '@micro-so/sdk';\n\nconst client = new Micro();\n\nconst organization = await client.prism.objects.organizations.create();\n\nconsole.log(organization);\n```",
    perLanguage: {
      typescript: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/organization \\\n    -X POST \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/organization/$ORGANIZATION_ID \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
    ...
    response: '{ id: string; crm?: object; default?: object; extended?: object; }',
    markdown:
      "## update\n\n`client.prism.objects.organizations.update(teamId: string, organizationId: string, id?: string, crm?: object, default?: object, extended?: object): { id: string; crm?: object; default?: object; extended?: object; }`\n\n**patch** `/v2/prism/{teamId}/organization/{organizationId}`\n\nPatch object\n\n### Parameters\n\n- `teamId: string`\n\n- `organizationId: string`\n\n- `id?: string`\n\n- `crm?: object`\n\n- `default?: object`\n  Properties keyed by property slug. Values can be strings, numbers, booleans, arrays, or null. For select/multiselect properties, values may be option slugs or option UUIDs on write; option slugs are returned on read.\n\n- `extended?: object`\n\n### Returns\n\n- `{ id: string; crm?: object; default?: object; extended?: object; }`\n  Object returned by reads (get/create/patch/restore). id is always present.\n\n  - `id: string`\n  - `crm?: object`\n  - `default?: object`\n  - `extended?: object`\n\n### Example\n\n```typescript\nimport Micro from '@micro-so/sdk';\n\nconst client = new Micro();\n\nconst organization = await client.prism.objects.organizations.update('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');\n\nconsole.log(organization);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      '{ data: { id: string; crm?: object; default?: object; extended?: object; }[]; has_more?: boolean; }',
    markdown:
      "## query\n\n`client.prism.objects.organizations.query(teamId: string, query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }, id?: string | string[], boxes?: string[], deleted?: boolean, sources?: string[]): { data: object[]; has_more?: boolean; }`\n\n**post** `/v2/prism/query/{teamId}/organization`\n\nQuery\n\n### Parameters\n\n- `teamId: string`\n\n- `query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }`\n  - `select: string[]`\n    Property slugs to select. Use dot notation for relationships (e.g. attendee.contact.first_name)\n  - `combinator?: 'AND' | 'OR'`\n    Logical operator for combining filters\n  - `crm_id?: string`\n  - `filter?: object[]`\n    Filters as [{ slug: { operator: value } }]. For select/multiselect properties, values may be option slugs or option UUIDs.\n  - `limit?: number`\n  - `page?: number`\n  - `sort?: object[]`\n    Sort order as [{ slug: direction }]. Array order determines sort priority\n\n- `id?: string | string[]`\n\n- `boxes?: string[]`\n\n- `deleted?: boolean`\n\n- `sources?: string[]`\n\n### Returns\n\n- `{ data: { id: string; crm?: object; default?: object; extended?: object; }[]; has_more?: boolean; }`\n\n  - `data: { id: string; crm?: object; default?: object; extended?: object; }[]`\n  - `has_more?: boolean`\n\n### Example\n\n```typescript\nimport Micro from '@micro-so/sdk';\n\nconst client = new Micro();\n\nconst response = await client.prism.objects.organizations.query({ query: { select: ['string'] } });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/query/$TEAM_ID/organization \\\n    -H \'Content-Type: application/json\' \\\n    -H "x-api-key: $MICRO_API_KEY" \\\n    -d \'{\n          "query": {\n            "select": [\n              "string"\n            ]\n          }\n        }\'',
      },
    },
  },
  {
    ...
    response:
      "{ results?: { id?: string; created?: boolean; error?: string; existing?: boolean; }[]; status?: 'complete'; summary?: { created?: number; errors?: number; existing?: number; total?: number; }; }",
    markdown:
      "## bulk_create\n\n`client.prism.objects.organizations.bulkCreate(teamId: string, objects: { id?: string; crm?: object; default?: object; extended?: object; }[], options?: { caseInsensitive?: boolean; crm_id?: string; dedupe_by?: string; }): { results?: object[]; status?: 'complete'; summary?: object; }`\n\n**post** `/v2/prism/{teamId}/organization/import`\n\nImport multiple objects in batch. Properties are keyed by slug. Automatically routes based on size: <100 records sync (immediate response), >=100 records async (S3/Lambda with WebSocket progress)\n\n### Parameters\n\n- `teamId: string`\n\n- `objects: { id?: string; crm?: object; default?: object; extended?: object; }[]`\n  Array of objects to import with property values keyed by slug\n\n- `options?: { caseInsensitive?: boolean; crm_id?: string; dedupe_by?: string; }`\n  - `caseInsensitive?: boolean`\n    Whether deduplication should be case insensitive\n  - `crm_id?: string`\n    App/CRM ID for context (optional)\n  - `dedupe_by?: string`\n    Property slug to deduplicate on\n\n### Returns\n\n- `{ results?: { id?: string; created?: boolean; error?: string; existing?: boolean; }[]; status?: 'complete'; summary?: { created?: number; errors?: number; existing?: number; total?: number; }; }`\n\n  - `results?: { id?: string; created?: boolean; error?: string; existing?: boolean; }[]`\n  - `status?: 'complete'`\n  - `summary?: { created?: number; errors?: number; existing?: number; total?: number; }`\n\n### Example\n\n```typescript\nimport Micro from '@micro-so/sdk';\n\nconst client = new Micro();\n\nconst response = await client.prism.objects.organizations.bulkCreate({ objects: [{}] });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/organization/import \\\n    -H \'Content-Type: application/json\' \\\n    -H "x-api-key: $MICRO_API_KEY" \\\n    -d \'{\n          "objects": [\n            {}\n          ]\n        }\'',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/organization/$ORGANIZATION_ID/duplicate \\\n    -X POST \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/organization/$ORGANIZATION_ID/restore \\\n    -X POST \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/identity \\\n    -X POST \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/identity/$IDENTITY_ID \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
  ...
  },
  {
    ...
    response:
      '{ data: { id: string; crm?: object; default?: object; extended?: object; }[]; has_more?: boolean; }',
    markdown:
      "## query\n\n`client.prism.objects.identities.query(teamId: string, query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }, id?: string | string[], boxes?: string[], deleted?: boolean, sources?: string[]): { data: object[]; has_more?: boolean; }`\n\n**post** `/v2/prism/query/{teamId}/identity`\n\nQuery\n\n### Parameters\n\n- `teamId: string`\n\n- `query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }`\n  - `select: string[]`\n    Property slugs to select. Use dot notation for relationships (e.g. attendee.contact.first_name)\n  - `combinator?: 'AND' | 'OR'`\n    Logical operator for combining filters\n  - `crm_id?: string`\n  - `filter?: object[]`\n    Filters as [{ slug: { operator: value } }]. For select/multiselect properties, values may be option slugs or option UUIDs.\n  - `limit?: number`\n  - `page?: number`\n  - `sort?: object[]`\n    Sort order as [{ slug: direction }]. Array order determines sort priority\n\n- `id?: string | string[]`\n\n- `boxes?: string[]`\n\n- `deleted?: boolean`\n\n- `sources?: string[]`\n\n### Returns\n\n- `{ data: { id: string; crm?: object; default?: object; extended?: object; }[]; has_more?: boolean; }`\n\n  - `data: { id: string; crm?: object; default?: object; extended?: object; }[]`\n  - `has_more?: boolean`\n\n### Example\n\n```typescript\nimport Micro from '@micro-so/sdk';\n\nconst client = new Micro();\n\nconst response = await client.prism.objects.identities.query({ query: { select: ['string'] } });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/query/$TEAM_ID/identity \\\n    -H \'Content-Type: application/json\' \\\n    -H "x-api-key: $MICRO_API_KEY" \\\n    -d \'{\n          "query": {\n            "select": [\n              "string"\n            ]\n          }\n        }\'',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/identity/import \\\n    -H \'Content-Type: application/json\' \\\n    -H "x-api-key: $MICRO_API_KEY" \\\n    -d \'{\n          "objects": [\n            {}\n          ]\n        }\'',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/identity/$IDENTITY_ID/duplicate \\\n    -X POST \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/identity/$IDENTITY_ID/restore \\\n    -X POST \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/deal \\\n    -X POST \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/deal/$DEAL_ID \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
  ...
  },
  {
    ...
    response:
      '{ data: { id: string; crm?: object; default?: object; extended?: object; }[]; has_more?: boolean; }',
    markdown:
      "## query\n\n`client.prism.objects.deals.query(teamId: string, query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }, id?: string | string[], boxes?: string[], deleted?: boolean, sources?: string[]): { data: object[]; has_more?: boolean; }`\n\n**post** `/v2/prism/query/{teamId}/deal`\n\nQuery\n\n### Parameters\n\n- `teamId: string`\n\n- `query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }`\n  - `select: string[]`\n    Property slugs to select. Use dot notation for relationships (e.g. attendee.contact.first_name)\n  - `combinator?: 'AND' | 'OR'`\n    Logical operator for combining filters\n  - `crm_id?: string`\n  - `filter?: object[]`\n    Filters as [{ slug: { operator: value } }]. For select/multiselect properties, values may be option slugs or option UUIDs.\n  - `limit?: number`\n  - `page?: number`\n  - `sort?: object[]`\n    Sort order as [{ slug: direction }]. Array order determines sort priority\n\n- `id?: string | string[]`\n\n- `boxes?: string[]`\n\n- `deleted?: boolean`\n\n- `sources?: string[]`\n\n### Returns\n\n- `{ data: { id: string; crm?: object; default?: object; extended?: object; }[]; has_more?: boolean; }`\n\n  - `data: { id: string; crm?: object; default?: object; extended?: object; }[]`\n  - `has_more?: boolean`\n\n### Example\n\n```typescript\nimport Micro from '@micro-so/sdk';\n\nconst client = new Micro();\n\nconst response = await client.prism.objects.deals.query({ query: { select: ['string'] } });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/query/$TEAM_ID/deal \\\n    -H \'Content-Type: application/json\' \\\n    -H "x-api-key: $MICRO_API_KEY" \\\n    -d \'{\n          "query": {\n            "select": [\n              "string"\n            ]\n          }\n        }\'',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/deal/import \\\n    -H \'Content-Type: application/json\' \\\n    -H "x-api-key: $MICRO_API_KEY" \\\n    -d \'{\n          "objects": [\n            {}\n          ]\n        }\'',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/deal/$DEAL_ID/duplicate \\\n    -X POST \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/deal/$DEAL_ID/restore \\\n    -X POST \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/grant/$TEAM_ID/deal/$DEAL_ID \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/action \\\n    -X POST \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/action/$ACTION_ID \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
  ...
  },
  {
    ...
    response:
      '{ data: { id: string; crm?: object; default?: object; extended?: object; }[]; has_more?: boolean; }',
    markdown:
      "## query\n\n`client.prism.objects.actions.query(teamId: string, query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }, id?: string | string[], boxes?: string[], deleted?: boolean, sources?: string[]): { data: object[]; has_more?: boolean; }`\n\n**post** `/v2/prism/query/{teamId}/action`\n\nQuery\n\n### Parameters\n\n- `teamId: string`\n\n- `query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }`\n  - `select: string[]`\n    Property slugs to select. Use dot notation for relationships (e.g. attendee.contact.first_name)\n  - `combinator?: 'AND' | 'OR'`\n    Logical operator for combining filters\n  - `crm_id?: string`\n  - `filter?: object[]`\n    Filters as [{ slug: { operator: value } }]. For select/multiselect properties, values may be option slugs or option UUIDs.\n  - `limit?: number`\n  - `page?: number`\n  - `sort?: object[]`\n    Sort order as [{ slug: direction }]. Array order determines sort priority\n\n- `id?: string | string[]`\n\n- `boxes?: string[]`\n\n- `deleted?: boolean`\n\n- `sources?: string[]`\n\n### Returns\n\n- `{ data: { id: string; crm?: object; default?: object; extended?: object; }[]; has_more?: boolean; }`\n\n  - `data: { id: string; crm?: object; default?: object; extended?: object; }[]`\n  - `has_more?: boolean`\n\n### Example\n\n```typescript\nimport Micro from '@micro-so/sdk';\n\nconst client = new Micro();\n\nconst response = await client.prism.objects.actions.query({ query: { select: ['string'] } });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/query/$TEAM_ID/action \\\n    -H \'Content-Type: application/json\' \\\n    -H "x-api-key: $MICRO_API_KEY" \\\n    -d \'{\n          "query": {\n            "select": [\n              "string"\n            ]\n          }\n        }\'',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/action/import \\\n    -H \'Content-Type: application/json\' \\\n    -H "x-api-key: $MICRO_API_KEY" \\\n    -d \'{\n          "objects": [\n            {}\n          ]\n        }\'',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/action/$ACTION_ID/duplicate \\\n    -X POST \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/action/$ACTION_ID/restore \\\n    -X POST \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/grant/$TEAM_ID/action/$ACTION_ID \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/document \\\n    -X POST \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/document/$DOCUMENT_ID \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
  ...
  },
  {
    ...
    response:
      '{ data: { id: string; crm?: object; default?: object; extended?: object; }[]; has_more?: boolean; }',
    markdown:
      "## query\n\n`client.prism.objects.documents.query(teamId: string, query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }, id?: string | string[], boxes?: string[], deleted?: boolean, sources?: string[]): { data: object[]; has_more?: boolean; }`\n\n**post** `/v2/prism/query/{teamId}/document`\n\nQuery\n\n### Parameters\n\n- `teamId: string`\n\n- `query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }`\n  - `select: string[]`\n    Property slugs to select. Use dot notation for relationships (e.g. attendee.contact.first_name)\n  - `combinator?: 'AND' | 'OR'`\n    Logical operator for combining filters\n  - `crm_id?: string`\n  - `filter?: object[]`\n    Filters as [{ slug: { operator: value } }]. For select/multiselect properties, values may be option slugs or option UUIDs.\n  - `limit?: number`\n  - `page?: number`\n  - `sort?: object[]`\n    Sort order as [{ slug: direction }]. Array order determines sort priority\n\n- `id?: string | string[]`\n\n- `boxes?: string[]`\n\n- `deleted?: boolean`\n\n- `sources?: string[]`\n\n### Returns\n\n- `{ data: { id: string; crm?: object; default?: object; extended?: object; }[]; has_more?: boolean; }`\n\n  - `data: { id: string; crm?: object; default?: object; extended?: object; }[]`\n  - `has_more?: boolean`\n\n### Example\n\n```typescript\nimport Micro from '@micro-so/sdk';\n\nconst client = new Micro();\n\nconst response = await client.prism.objects.documents.query({ query: { select: ['string'] } });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/query/$TEAM_ID/document \\\n    -H \'Content-Type: application/json\' \\\n    -H "x-api-key: $MICRO_API_KEY" \\\n    -d \'{\n          "query": {\n            "select": [\n              "string"\n            ]\n          }\n        }\'',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/document/import \\\n    -H \'Content-Type: application/json\' \\\n    -H "x-api-key: $MICRO_API_KEY" \\\n    -d \'{\n          "objects": [\n            {}\n          ]\n        }\'',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/document/$DOCUMENT_ID/duplicate \\\n    -X POST \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/document/$DOCUMENT_ID/restore \\\n    -X POST \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/grant/$TEAM_ID/document/$DOCUMENT_ID \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/event/$EVENT_ID \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
    ...
    response:
      '{ data: { id: string; crm?: object; default?: object; extended?: object; }[]; has_more?: boolean; }',
    markdown:
      "## query\n\n`client.prism.objects.events.query(teamId: string, query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }, id?: string | string[], boxes?: string[], deleted?: boolean, sources?: string[]): { data: object[]; has_more?: boolean; }`\n\n**post** `/v2/prism/query/{teamId}/event`\n\nQuery\n\n### Parameters\n\n- `teamId: string`\n\n- `query: { select: string[]; combinator?: 'AND' | 'OR'; crm_id?: string; filter?: object[]; limit?: number; page?: number; sort?: object[]; }`\n  - `select: string[]`\n    Property slugs to select. Use dot notation for relationships (e.g. attendee.contact.first_name)\n  - `combinator?: 'AND' | 'OR'`\n    Logical operator for combining filters\n  - `crm_id?: string`\n  - `filter?: object[]`\n    Filters as [{ slug: { operator: value } }]. For select/multiselect properties, values may be option slugs or option UUIDs.\n  - `limit?: number`\n  - `page?: number`\n  - `sort?: object[]`\n    Sort order as [{ slug: direction }]. Array order determines sort priority\n\n- `id?: string | string[]`\n\n- `boxes?: string[]`\n\n- `deleted?: boolean`\n\n- `sources?: string[]`\n\n### Returns\n\n- `{ data: { id: string; crm?: object; default?: object; extended?: object; }[]; has_more?: boolean; }`\n\n  - `data: { id: string; crm?: object; default?: object; extended?: object; }[]`\n  - `has_more?: boolean`\n\n### Example\n\n```typescript\nimport Micro from '@micro-so/sdk';\n\nconst client = new Micro();\n\nconst response = await client.prism.objects.events.query({ query: { select: ['string'] } });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/query/$TEAM_ID/event \\\n    -H \'Content-Type: application/json\' \\\n    -H "x-api-key: $MICRO_API_KEY" \\\n    -d \'{\n          "query": {\n            "select": [\n              "string"\n            ]\n          }\n        }\'',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/grant/$TEAM_ID/event/$EVENT_ID \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/view/$VIEW_OBJECT_TYPE \\\n    -H \'Content-Type: application/json\' \\\n    -H "x-api-key: $MICRO_API_KEY" \\\n    -d \'{\n          "name": "name",\n          "view_type": "view_type"\n        }\'',
      },
    },
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/view/$VIEW_OBJECT_TYPE/$VIEW_ID \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/view/$VIEW_OBJECT_TYPE/$VIEW_ID/records \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://developers.staging.micro.so/v2/prism/$TEAM_ID/view/$VIEW_OBJECT_TYPE/$VIEW_ID/records/$OBJECT_ID \\\n    -X POST \\\n    -H "x-api-key: $MICRO_API_KEY"',
      },
    },
  },
  {
