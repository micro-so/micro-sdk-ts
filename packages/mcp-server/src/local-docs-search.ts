...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "prism restore_object",
        "example": "micro prism restore-object \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --object-type deal \\\n  --object-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/$TEAM_ID/$OBJECT_TYPE/$OBJECT_ID/restore \\\n    -X POST \\\n    -H \"x-api-key: $MICRO_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "prism duplicate_object",
        "example": "micro prism duplicate-object \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --object-type deal \\\n  --object-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/$TEAM_ID/$OBJECT_TYPE/$OBJECT_ID/duplicate \\\n    -X POST \\\n    -H \"x-api-key: $MICRO_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "prism create_object",
        "example": "micro prism create-object \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --object-type deal"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/$TEAM_ID/$OBJECT_TYPE \\\n    -H 'Content-Type: application/json' \\\n    -H \"x-api-key: $MICRO_API_KEY\" \\\n    -d '{}'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "prism delete_object",
        "example": "micro prism delete-object \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --object-type deal \\\n  --object-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/$TEAM_ID/$OBJECT_TYPE/$OBJECT_ID \\\n    -X DELETE \\\n    -H \"x-api-key: $MICRO_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "prism patch_object",
        "example": "micro prism patch-object \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --object-type deal \\\n  --object-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/$TEAM_ID/$OBJECT_TYPE/$OBJECT_ID \\\n    -X PATCH \\\n    -H 'Content-Type: application/json' \\\n    -H \"x-api-key: $MICRO_API_KEY\" \\\n    -d '{}'"
      }
  ...
  },
  {
    ...
    "description": "Import multiple objects in batch. Properties are keyed by slug. Automatically routes based on size: <100 records sync (immediate response), >=100 records async (S3/Lambda with WebSocket progress)",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "prism import_objects",
        "example": "micro prism import-objects \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --object-type identity \\\n  --object '{}'"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/$TEAM_ID/$OBJECT_TYPE/import \\\n    -H 'Content-Type: application/json' \\\n    -H \"x-api-key: $MICRO_API_KEY\" \\\n    -d '{\n          \"objects\": [\n            {}\n          ]\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "micro prism:grant retrieve-grant \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --object-type deal \\\n  --object-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/grant/$TEAM_ID/$OBJECT_TYPE/$OBJECT_ID \\\n    -H \"x-api-key: $MICRO_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "micro prism:grant update-grant \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --object-type deal \\\n  --object-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/grant/$TEAM_ID/$OBJECT_TYPE/$OBJECT_ID \\\n    -X PUT \\\n    -H 'Content-Type: application/json' \\\n    -H \"x-api-key: $MICRO_API_KEY\" \\\n    -d '{}'"
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "micro prism:query execute \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --object-type deal \\\n  --query '{select: [string]}'"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/query/$TEAM_ID/$OBJECT_TYPE \\\n    -H 'Content-Type: application/json' \\\n    -H \"x-api-key: $MICRO_API_KEY\" \\\n    -d '{\n          \"query\": {\n            \"select\": [\n              \"string\"\n            ]\n          }\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "micro prism:metadata properties \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --object-type deal"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/metadata/properties/$TEAM_ID/$OBJECT_TYPE \\\n    -H \"x-api-key: $MICRO_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "contacts create",
        "example": "micro contacts create \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/$TEAM_ID/contact \\\n    -X POST \\\n    -H \"x-api-key: $MICRO_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "contacts update",
        "example": "micro contacts update \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --contact-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/$TEAM_ID/contact/$CONTACT_ID \\\n    -X PATCH \\\n    -H 'Content-Type: application/json' \\\n    -H \"x-api-key: $MICRO_API_KEY\" \\\n    -d '{}'"
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "contacts list",
        "example": "micro contacts list \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --query '{select: [string]}'"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/query/$TEAM_ID/contact \\\n    -H 'Content-Type: application/json' \\\n    -H \"x-api-key: $MICRO_API_KEY\" \\\n    -d '{\n          \"query\": {\n            \"select\": [\n              \"string\"\n            ]\n          }\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "micro contacts import \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --object '{}'"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/$TEAM_ID/contact/import \\\n    -H 'Content-Type: application/json' \\\n    -H \"x-api-key: $MICRO_API_KEY\" \\\n    -d '{\n          \"objects\": [\n            {}\n          ]\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "organizations create",
        "example": "micro organizations create \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/$TEAM_ID/organization \\\n    -X POST \\\n    -H \"x-api-key: $MICRO_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "organizations update",
        "example": "micro organizations update \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --organization-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/$TEAM_ID/organization/$ORGANIZATION_ID \\\n    -X PATCH \\\n    -H 'Content-Type: application/json' \\\n    -H \"x-api-key: $MICRO_API_KEY\" \\\n    -d '{}'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "organizations delete",
        "example": "micro organizations delete \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --organization-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/$TEAM_ID/organization/$ORGANIZATION_ID \\\n    -X DELETE \\\n    -H \"x-api-key: $MICRO_API_KEY\""
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "organizations list",
        "example": "micro organizations list \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --query '{select: [string]}'"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/query/$TEAM_ID/organization \\\n    -H 'Content-Type: application/json' \\\n    -H \"x-api-key: $MICRO_API_KEY\" \\\n    -d '{\n          \"query\": {\n            \"select\": [\n              \"string\"\n            ]\n          }\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "micro organizations import \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --object '{}'"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/$TEAM_ID/organization/import \\\n    -H 'Content-Type: application/json' \\\n    -H \"x-api-key: $MICRO_API_KEY\" \\\n    -d '{\n          \"objects\": [\n            {}\n          ]\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "identities create",
        "example": "micro identities create \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/$TEAM_ID/identity \\\n    -X POST \\\n    -H \"x-api-key: $MICRO_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "identities update",
        "example": "micro identities update \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --identity-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/$TEAM_ID/identity/$IDENTITY_ID \\\n    -X PATCH \\\n    -H 'Content-Type: application/json' \\\n    -H \"x-api-key: $MICRO_API_KEY\" \\\n    -d '{}'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "identities delete",
        "example": "micro identities delete \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --identity-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/$TEAM_ID/identity/$IDENTITY_ID \\\n    -X DELETE \\\n    -H \"x-api-key: $MICRO_API_KEY\""
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "identities list",
        "example": "micro identities list \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --query '{select: [string]}'"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/query/$TEAM_ID/identity \\\n    -H 'Content-Type: application/json' \\\n    -H \"x-api-key: $MICRO_API_KEY\" \\\n    -d '{\n          \"query\": {\n            \"select\": [\n              \"string\"\n            ]\n          }\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "micro identities import \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --object '{}'"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/$TEAM_ID/identity/import \\\n    -H 'Content-Type: application/json' \\\n    -H \"x-api-key: $MICRO_API_KEY\" \\\n    -d '{\n          \"objects\": [\n            {}\n          ]\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "deals create",
        "example": "micro deals create \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/$TEAM_ID/deal \\\n    -X POST \\\n    -H \"x-api-key: $MICRO_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "deals update",
        "example": "micro deals update \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --deal-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/$TEAM_ID/deal/$DEAL_ID \\\n    -X PATCH \\\n    -H 'Content-Type: application/json' \\\n    -H \"x-api-key: $MICRO_API_KEY\" \\\n    -d '{}'"
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "deals list",
        "example": "micro deals list \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --query '{select: [string]}'"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/query/$TEAM_ID/deal \\\n    -H 'Content-Type: application/json' \\\n    -H \"x-api-key: $MICRO_API_KEY\" \\\n    -d '{\n          \"query\": {\n            \"select\": [\n              \"string\"\n            ]\n          }\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "deals import",
        "example": "micro deals import \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --object '{}'"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/$TEAM_ID/deal/import \\\n    -H 'Content-Type: application/json' \\\n    -H \"x-api-key: $MICRO_API_KEY\" \\\n    -d '{\n          \"objects\": [\n            {}\n          ]\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "actions create",
        "example": "micro actions create \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/$TEAM_ID/action \\\n    -X POST \\\n    -H \"x-api-key: $MICRO_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "actions update",
        "example": "micro actions update \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --action-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/$TEAM_ID/action/$ACTION_ID \\\n    -X PATCH \\\n    -H 'Content-Type: application/json' \\\n    -H \"x-api-key: $MICRO_API_KEY\" \\\n    -d '{}'"
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "actions list",
        "example": "micro actions list \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --query '{select: [string]}'"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/query/$TEAM_ID/action \\\n    -H 'Content-Type: application/json' \\\n    -H \"x-api-key: $MICRO_API_KEY\" \\\n    -d '{\n          \"query\": {\n            \"select\": [\n              \"string\"\n            ]\n          }\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "events list",
        "example": "micro events list \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --query '{select: [string]}'"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/query/$TEAM_ID/event \\\n    -H 'Content-Type: application/json' \\\n    -H \"x-api-key: $MICRO_API_KEY\" \\\n    -d '{\n          \"query\": {\n            \"select\": [\n              \"string\"\n            ]\n          }\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "documents create",
        "example": "micro documents create \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/$TEAM_ID/document \\\n    -X POST \\\n    -H \"x-api-key: $MICRO_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "documents update",
        "example": "micro documents update \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --document-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/$TEAM_ID/document/$DOCUMENT_ID \\\n    -X PATCH \\\n    -H 'Content-Type: application/json' \\\n    -H \"x-api-key: $MICRO_API_KEY\" \\\n    -d '{}'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "documents delete",
        "example": "micro documents delete \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --document-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/$TEAM_ID/document/$DOCUMENT_ID \\\n    -X DELETE \\\n    -H \"x-api-key: $MICRO_API_KEY\""
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "documents list",
        "example": "micro documents list \\\n  --api-key 'My API Key' \\\n  --team-id 'My Team ID' \\\n  --team-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --query '{select: [string]}'"
      },
      "http": {
        "example": "curl https://developers.micro.so/v2/prism/query/$TEAM_ID/document \\\n    -H 'Content-Type: application/json' \\\n    -H \"x-api-key: $MICRO_API_KEY\" \\\n    -d '{\n          \"query\": {\n            \"select\": [\n              \"string\"\n            ]\n          }\n        }'"
      }
    }
  }
];
