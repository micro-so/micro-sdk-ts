...
describe('resource identities', () => {
  ...
  test.skip('create: request options and params are passed correctly', async () => {
    ...
    await expect(client.identities.create({
    teamId: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
    id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
    crm: {},
    default: { foo: 'bar' },
  ...
  test.skip('update: required and optional params', async () => {
    const response = await client.identities.update('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
    teamId: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
    id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
    crm: {},
    default: { foo: 'bar' },
  ...
  test.skip('list: only required params', async () => {
    const responsePromise = client.identities.list({ query: { select: ['string'] } });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('delete: required and optional params', async () => {
    const response = await client.identities.delete('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { teamId: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e' });
  });

  // Mock server tests are disabled
  test.skip('delete: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.identities.delete('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { teamId: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e' }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(Micro.NotFoundError);
  });
  ...
  test.skip('import: only required params', async () => {
    const responsePromise = client.identities.import({ objects: [{}] });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('import: required and optional params', async () => {
    const response = await client.identities.import({
    teamId: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
    objects: [{
    id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
    crm: {},
