...
describe('resource documents', () => {
  ...
  test.skip('list: only required params', async () => {
    const responsePromise = client.prism.objects.documents.list();
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('list: required and optional params', async () => {
    const response = await client.prism.objects.documents.list({
      teamId: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      cursor: 'cursor',
      deleted: true,
      include_total: true,
  ...
  test.skip('bulkDelete: only required params', async () => {
    const responsePromise = client.prism.objects.documents.bulkDelete({
  ...
  test.skip('bulkUpdate: only required params', async () => {
    const responsePromise = client.prism.objects.documents.bulkUpdate({
  ...
  test.skip('count: only required params', async () => {
    const responsePromise = client.prism.objects.documents.count();
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('find: only required params', async () => {
    const responsePromise = client.prism.objects.documents.find('value', { slug: 'slug' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('find: required and optional params', async () => {
    const response = await client.prism.objects.documents.find('value', {
      teamId: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      slug: 'slug',
      list_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
    });
  ...
  test.skip('query: only required params', async () => {
    const responsePromise = client.prism.objects.documents.query({
  ...
  test.skip('upsert: only required params', async () => {
    const responsePromise = client.prism.objects.documents.upsert('value', { slug: 'slug' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('upsert: required and optional params', async () => {
    const response = await client.prism.objects.documents.upsert('value', {
      teamId: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      slug: 'slug',
      list_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      default: { foo: 'bar' },
