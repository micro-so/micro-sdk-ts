...
describe('resource contacts', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.prism.objects.contacts.create();
  ...
  test.skip('create: required and optional params', async () => {
    const response = await client.prism.objects.contacts.create({
  ...
  test.skip('update: only required params', async () => {
    const responsePromise = client.prism.objects.contacts.update('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {});
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('update: required and optional params', async () => {
    const response = await client.prism.objects.contacts.update('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
      teamId: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      default: { foo: 'bar' },
      list: {},
      'Idempotency-Key': 'x',
  ...
  test.skip('list: only required params', async () => {
    const responsePromise = client.prism.objects.contacts.list();
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('list: required and optional params', async () => {
    const response = await client.prism.objects.contacts.list({
      teamId: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      cursor: 'cursor',
      deleted: true,
      include_total: true,
  ...
  test.skip('delete: only required params', async () => {
    const responsePromise = client.prism.objects.contacts.delete('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('delete: required and optional params', async () => {
    const response = await client.prism.objects.contacts.delete('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
      teamId: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      'If-Match': 'If-Match',
    });
  });
  ...
  test.skip('bulkCreate: only required params', async () => {
    const responsePromise = client.prism.objects.contacts.bulkCreate({ objects: [{}] });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('bulkCreate: required and optional params', async () => {
    const response = await client.prism.objects.contacts.bulkCreate({
      teamId: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      objects: [
        {
          default: { foo: 'bar' },
  ...
  test.skip('bulkDelete: only required params', async () => {
    const responsePromise = client.prism.objects.contacts.bulkDelete({
  ...
  test.skip('bulkUpdate: only required params', async () => {
    const responsePromise = client.prism.objects.contacts.bulkUpdate({
  ...
  test.skip('count: only required params', async () => {
    const responsePromise = client.prism.objects.contacts.count();
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('duplicate: only required params', async () => {
    const responsePromise = client.prism.objects.contacts.duplicate('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('find: only required params', async () => {
    const responsePromise = client.prism.objects.contacts.find('value', { slug: 'slug' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('find: required and optional params', async () => {
    const response = await client.prism.objects.contacts.find('value', {
      teamId: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      slug: 'slug',
      list_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
    });
  ...
  test.skip('get: only required params', async () => {
    const responsePromise = client.prism.objects.contacts.get('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('get: required and optional params', async () => {
    const response = await client.prism.objects.contacts.get('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
      teamId: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      select: 'select',
    });
  });
  ...
  test.skip('query: only required params', async () => {
    const responsePromise = client.prism.objects.contacts.query({ query: { select: ['string'] } });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('restore: only required params', async () => {
    const responsePromise = client.prism.objects.contacts.restore('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('upsert: only required params', async () => {
    const responsePromise = client.prism.objects.contacts.upsert('value', { slug: 'slug' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('upsert: required and optional params', async () => {
    const response = await client.prism.objects.contacts.upsert('value', {
      teamId: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      slug: 'slug',
      list_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      default: { foo: 'bar' },
