...
describe('resource prism', () => {
  ...
  test.skip('deleteObject: only required params', async () => {
    const responsePromise = client.prism.deleteObject('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { objectType: 'deal' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('deleteObject: required and optional params', async () => {
    const response = await client.prism.deleteObject('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { teamId: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', objectType: 'deal' });
  });

  // Mock server tests are disabled
  test.skip('duplicateObject: only required params', async () => {
    const responsePromise = client.prism.duplicateObject('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { objectType: 'deal' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('duplicateObject: required and optional params', async () => {
    const response = await client.prism.duplicateObject('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { teamId: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', objectType: 'deal' });
  });
  ...
  test.skip('patchObject: only required params', async () => {
    const responsePromise = client.prism.patchObject('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { objectType: 'deal' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('restoreObject: only required params', async () => {
    const responsePromise = client.prism.restoreObject('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { objectType: 'deal' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('restoreObject: required and optional params', async () => {
    const response = await client.prism.restoreObject('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { teamId: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', objectType: 'deal' });
  });
});
